                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('penduduk.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <!-- HEADER SECTION - Data Kartu Keluarga (Grid Layout) -->
                            <div class="row mb-4">
                                <div class="col-12">
                                    <h5 class="mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control @error('nomor_kk') is-invalid @enderror" id="nomor_kk"
                                                name="nomor_kk" value="{{ old('nomor_kk') }}" required placeholder="16 digit Nomor KK"
                                                inputmode="numeric"
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control @error('jenis_bangunan') is-invalid @enderror"
                                                id="jenis_bangunan" name="jenis_bangunan" value="{{ old('jenis_bangunan') }}" placeholder="Contoh: Permanen">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control @error('pemakaian_air') is-invalid @enderror"
                                                id="pemakaian_air" name="pemakaian_air" value="{{ old('pemakaian_air') }}" placeholder="Contoh: PDAM">
                                            @error('pemakaian_air')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control @error('jenis_bantuan') is-invalid @enderror"
                                                id="jenis_bantuan" name="jenis_bantuan" value="{{ old('jenis_bantuan') }}" placeholder="Contoh: BPNT">
                                            @error('jenis_bantuan')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                            ...
                            <!-- REPEATER SECTION - Data Anggota Keluarga (Card Layout) -->
                            <div class="row mb-4">
                                <div class="col-12">
                                ...
                                <div class="col-12" id="anggotaContainer">
                                    <!-- Card Anggota 1 (Default) -->
                                    <div class="card mb-3 anggota-row shadow-sm" data-index="0">
                                        <div class="card-header d-flex justify-content-between align-items-center bg-light">
                                            <h6 class="mb-0 fw-bold text-primary"><i class="fas fa-user"></i> Anggota 1</h6>
                                            <button type="button" class="btn btn-danger btn-sm hapus-anggota" disabled title="Hapus anggota ini">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="text" class="form-control nik-input @error('anggota.0.nik') is-invalid @enderror"
                                                        name="anggota[0][nik]" value="{{ old('anggota.0.nik') }}" required placeholder="16 digit NIK"
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="text" class="form-control nama-input @error('anggota.0.nama') is-invalid @enderror"
                                                        name="anggota[0][nama]" value="{{ old('anggota.0.nama') }}" required placeholder="Nama Lengkap">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <select class="form-select gender-input @error('anggota.0.jenis_kelamin') is-invalid @enderror"
                                                        name="anggota[0][jenis_kelamin]" required style="width: 75%;">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <select class="form-select hubungan-input @error('anggota.0.hubungan_keluarga') is-invalid @enderror"
                                                        name="anggota[0][hubungan_keluarga]" required style="width: 75%;">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="text" class="form-control tempat-lahir-input @error('anggota.0.tempat_lahir') is-invalid @enderror"
                                                        name="anggota[0][tempat_lahir]" value="{{ old('anggota.0.tempat_lahir') }}" required placeholder="Contoh: Jakarta">
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                ...
                                                <div class="col-md-1 mb-3">
                                                    ...
                                                    <input type="text" class="form-control usia-input bg-light"
                                                        name="anggota[0][usia]" value="{{ old('anggota.0.usia') }}" readonly placeholder="Auto">
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="text" class="form-control pekerjaan-input @error('anggota.0.pekerjaan') is-invalid @enderror"
                                                        name="anggota[0][pekerjaan]" value="{{ old('anggota.0.pekerjaan') }}" required placeholder="Contoh: Wiraswasta">
                                                </div>
                                                <div class="col-md-2 mb-3">
                                                    <label class="form-label fw-bold small text-uppercase">Tamatan</label>
                                                    <select class="form-select tamatan-input @error('anggota.0.tamatan') is-invalid @enderror"
    ...
    <script>
        $(document).ready(function() {
            ...
            function hitungUsia(tanggalLahir) {
                ...
                // Menghitung usia hanya berdasarkan tahun
            ...
            $(document).on('change', '.tgl-lahir-input', function() {
                ...
                const usiaInput = $(this).closest('.anggota-row').find('.usia-input');
