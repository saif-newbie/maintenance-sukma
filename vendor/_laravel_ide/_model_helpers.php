...
namespace App\Models {
     ...
     * @property string|null $jenis_bantuan
     * @property string|null $pemakaian_air
     * @property string|null $jenis_bangunan
     * @property string|null $kategori_sejahtera
     * @property string|null $dusun
     * @property string $no_kk
     * @property int $id
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Penduduk> $anggota
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<KartuKeluarga>|KartuKeluarga whereNoKk($value)
     * @method static \Illuminate\Database\Eloquent\Builder<KartuKeluarga>|KartuKeluarga whereDusun($value)
     * @method static \Illuminate\Database\Eloquent\Builder<KartuKeluarga>|KartuKeluarga whereKategoriSejahtera($value)
     * @method static \Illuminate\Database\Eloquent\Builder<KartuKeluarga>|KartuKeluarga whereJenisBangunan($value)
     * @method static \Illuminate\Database\Eloquent\Builder<KartuKeluarga>|KartuKeluarga wherePemakaianAir($value)
     * @method static \Illuminate\Database\Eloquent\Builder<KartuKeluarga>|KartuKeluarga whereJenisBantuan($value)
     ...
     * @property \Illuminate\Support\Carbon $tanggal_kejadian
     * @property mixed $jenis_mutasi
     * @property mixed $penduduk_id
     * @property int $id
     * @property-read \App\Models\Penduduk $penduduk
     * @method static \Illuminate\Database\Eloquent\Builder<Mutasi>|Mutasi whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Mutasi>|Mutasi wherePendudukId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Mutasi>|Mutasi whereJenisMutasi($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Mutasi>|Mutasi whereTanggalKejadian($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Mutasi>|Mutasi whereLokasiDetail($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Mutasi>|Mutasi whereKeterangan($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Mutasi>|Mutasi whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Mutasi>|Mutasi whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Mutasi>|Mutasi newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Mutasi>|Mutasi newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Mutasi>|Mutasi query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class Mutasi extends \Illuminate\Database\Eloquent\Model
    {
        //
    }

    /**
     * App\Models\Penambahan
     *
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property string $keterangan
     * @property string $tanggal_penambahan
     * @property mixed $jenis_penambahan
     * @property mixed $id_penduduk
     * @property mixed $id_penambahan
     * @method static \Illuminate\Database\Eloquent\Builder<Penambahan>|Penambahan whereIdPenambahan($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Penambahan>|Penambahan whereIdPenduduk($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Penambahan>|Penambahan whereJenisPenambahan($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Penambahan>|Penambahan whereTanggalPenambahan($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Penambahan>|Penambahan whereKeterangan($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Penambahan>|Penambahan whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Penambahan>|Penambahan whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Penambahan>|Penambahan newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Penambahan>|Penambahan newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Penambahan>|Penambahan query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class Penambahan extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property string $nik
     * @property mixed $kartu_keluarga_id
     * @property int $id
     * @property-read mixed $usia
     * @property-read mixed $no_kk
     * @property-read mixed $peran_keluarga
     * @property-read mixed $jenis_kelamin_display
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Penduduk>|Penduduk whereKartuKeluargaId($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Penduduk>|Penduduk whereTglLahir($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Penduduk>|Penduduk wherePekerjaan($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Penduduk>|Penduduk whereHubunganKeluarga($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Penduduk>|Penduduk whereTamatan($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Penduduk>|Penduduk whereDusun($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Penduduk>|Penduduk whereStatus($value)
